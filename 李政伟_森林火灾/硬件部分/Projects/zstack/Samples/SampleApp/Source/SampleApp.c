...
{
  uint16 flashTime;
  unsigned short len = 6+3+1+1+3+1;
  byte buf[6+3+1+1+3+1]={0}; 
...
{ 
  ...
  uint16 humi = ReadHumidityData();
  sprintf(str,"%s%3d%d%3d\n",temp_humi,gas,fire,humi);
