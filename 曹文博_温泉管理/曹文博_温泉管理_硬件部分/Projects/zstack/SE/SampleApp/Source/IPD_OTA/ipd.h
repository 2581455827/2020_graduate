...
#define SE_OTA_POLL_RATE              100   // Poll rate for SE OTA process
...
#define IPD_OTA_MAX_SERVERS                 6

#define IPD_OTA_IDLE_STATE                  0
#define IPD_OTA_CBKE_STATE                  1
#define IPD_OTA_DL_STATE                    2
