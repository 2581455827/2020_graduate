...
//SCL -> PE7
//SDA -> PE8
#define SCL_H()  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7,GPIO_PIN_SET)
#define SCL_L()  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7,GPIO_PIN_RESET)
#define SDA_H()  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8,GPIO_PIN_SET)
#define SDA_L()  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8,GPIO_PIN_RESET)
 
#define SDA  HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_8)
